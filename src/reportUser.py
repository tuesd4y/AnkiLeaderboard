...
class start_report(QDialog):
    ...
    def setupUI(self):
        ...
        self.dialog.reportLabel.setText(
            f"Please explain why you want to report {self.user_clicked}:"
        )
    ...
    def sendReport(self):
        ...
        data = {
            ...
            "reportUser": self.user_clicked,
            "message": self.dialog.reportReason.toPlainText(),
        }
